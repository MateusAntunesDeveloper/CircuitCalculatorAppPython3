...
class CircuitCalculatorApp:
    def __init__(self, root):
        ...
        sccren_width = self.root.winfo_screenwidth()
        sccren__light=self.root.winfo_screenmmheight()


        #define o tamanho da tela no PC win/linx/etccc...

        width= int(sccren_width* 0.9)
        height= int(sccren__light* 0.9)


        WID= (sccren_width - width) //2
        LIT=(sccren__light-height)// 2
        ...
        self.select_button.grid(row=1, column=35, padx=30, pady=10, sticky="w")
